...
# Status and Aim {data-background-color="#006ab2"}

## Current Situation

<br>

Modeling and data science became an important part of limnology.
...
- Role: Collect data, inform research, experimental design

**2. Ecological Data Analysts**

- Skills: Ecology, data analysis, statistics, communication
- Role: Analyze data, inform decisions

**3. Ecological Modelers**

- Skills: Ecology, statistics and modeling, programming, computation
- Role: Develop models, simulate processes, interpret outcomes

**4. Ecological Data Science and Modeling Specialists**
...
::: {.column width="33%"}
<br>
* Visualisation of climate trends
* Direct access to DWD data
* Successfully used in teaching and public outreach
:::
...
::: {.column width="33%"}
<br>
* Full hydrophysical model as web service
* 1D model, quick performance
...
$$
N_{t+1} = r_{max} \cdot N_{t} \cdot \left(1-\frac{N}{K}\right)
$$
...
computer model. Both approaches work." (J. W. Forrester, 1995)
...
* Formulation of texts:
    ...
    - appropriate level (some prerequisites make understanding easier)
* Graphical presentation needs professionals.
* Avoid "cinema mode" 
* Encourage self study and advanced courses
