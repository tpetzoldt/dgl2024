...
* intuitive understanding of mechanisms 
* needs numrical solver
...
$$
* can be plotted with Excel
* mechanisms difficult to access
...
* Modern didactic concept requred, technical approach is not enough.
